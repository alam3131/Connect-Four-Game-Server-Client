...
1.  Run the server by running the command "mvn clean javafx:run" in the terminal of the window for the server code.
...
- Apache Maven 3.9.9 (Build & Dependency Tool)
